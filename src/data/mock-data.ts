...
const MOCK_DATA = {
  ...
  roles: {
    ...
    '全权限测试账号': {
      nav: ['dashboard', 'project', 'decision-system', 'progress-system', 'design-control', 'documents', 'work-mgmt', 'cost-system', 'material', 'supplier-system', 'cashflow', 'risk-system', 'safety-log', 'coordination', 'reports', 'sync'],
      name: '测试管理员',
    }
  },

  // 四个地块（来源：黄埔城建项目现场情况和需求PPT）
  projects: [
    {
      id: 'xl_fj01',
      name: '新联复建01地块',
  ...
  projectDetails: {
    ...
    jyje_az01: {
      licenses: [
        { name: '施工许可证（一期）', status: 'done', date: '2025-08-15', deadline: '—', warn: false },
        { name: '施工许可证（二期）', status: 'doing', date: '—', deadline: '2026-09-30', warn: false },
        { name: '临水临电', status: 'done', date: '2025-06-10', deadline: '—', warn: false },
        { name: '林地林牌', status: 'done', date: '2025-09-20', deadline: '—', warn: false }
      ],
      designProgress: [
        { major: '建筑', plan: '2025-05-31', actual: '2025-06-08', rate: 100, lag: false },
        { major: '结构', plan: '2025-07-15', actual: '2025-07-22', rate: 100, lag: false },
        { major: '机电', plan: '2025-11-30', actual: '2025-12-15', rate: 90, lag: true },
        { major: '精装修', plan: '2026-04-30', actual: '—', rate: 40, lag: false }
      ],
      milestones: [
        { name: '土方工程完成', plan: '2025-10-31', actual: '2025-11-05', status: 'lag', reason: '雨季影响，土方外运延期5天' },
        { name: '地下室结构封顶', plan: '2026-06-30', actual: '—', status: 'doing', reason: '' },
        { name: '主体结构封顶', plan: '2027-02-28', actual: '—', status: 'pending', reason: '' },
        { name: '竣工验收', plan: '2028-06-30', actual: '—', status: 'pending', reason: '' }
      ],
      risks: {
        engineering: [
          { level: 'red', desc: '基坑支护位移监测值接近预警线', owner: '赵工', status: '处理中', deadline: '2026-05-30' },
          { level: 'yellow', desc: '雨季基坑排水能力不足', owner: '王工', status: '待处理', deadline: '2026-06-05' }
        ],
        economic: [
          { level: 'yellow', desc: '地下室造价超目标成本约120万', owner: '商务部', status: '处理中', deadline: '2026-06-15' },
          { level: 'blue', desc: '桩基变更签证待业主确认', owner: '商务部', status: '已评估', deadline: '2026-05-25' }
        ],
        design: [
          { level: 'yellow', desc: '机电管线综合排布深化滞后', owner: '工程技术部', status: '处理中', deadline: '2026-06-10' }
        ]
      },
      costSections: [
        { name: '前期工程', value: 0.18, pct: 2.0 },
        { name: '土方及基坑', value: 1.15, pct: 12.9 },
        { name: '地下室', value: 4.58, pct: 51.4 },
        { name: '高层住宅', value: 2.16, pct: 24.2 },
        { name: '公建配套', value: 0.28, pct: 3.1 },
        { name: '外墙', value: 0.48, pct: 5.4 },
        { name: '其他', value: 0.08, pct: 1.0 }
      ],
      threeValueCompare: [
        { major: '土方及基坑', tender: 1.21, bid: 1.15, target: 0.88, actual: 0.92 },
        { major: '地下室', tender: 4.62, bid: 4.39, target: 3.35, actual: 3.47 },
        { major: '高层住宅', tender: 2.28, bid: 2.16, target: 1.72, actual: 1.69 },
        { major: '外墙', tender: 0.52, bid: 0.48, target: 0.34, actual: 0.33 },
        { major: '精装修', tender: 0.98, bid: 0.92, target: 0.72, actual: 0.70 }
      ],
      benchmarkTop: [
        { item: '地下室混凝土工程', diff: 9.2, amount: 148.3, reason: 'C35用量超设计' },
        { item: '桩基工程', diff: 7.8, amount: 92.6, reason: '地层变化增加桩长' },
        { item: '土方外运', diff: 6.5, amount: 45.2, reason: '运距增加' }
      ],
      benchmarkSave: [
        { item: '模板工程', diff: -7.8, amount: -48.6, reason: '铝模板周转' },
        { item: '钢筋工程', diff: -5.9, amount: -35.2, reason: '集中采购优惠' }
      ],
      otherDirectCosts: {
        versions: ['标前版', '第三方版', '一体化单位版'],
        items: [
          { name: '临时设施费', v1: 420, v2: 438, v3: 430 },
          { name: '安全文明施工费', v1: 680, v2: 695, v3: 688 },
          { name: '管理费', v1: 1520, v2: 1560, v3: 1540 },
          { name: '利润', v1: 1180, v2: 1205, v3: 1192 }
        ]
      },
      subcontracts: [
        { company: '粤建桩基工程', contract: 680, paid: 410, remain: 270, overpay: false },
        { company: '华南装饰', contract: 1250, paid: 560, remain: 690, overpay: false },
        { company: '广达机电', contract: 980, paid: 720, remain: 260, overpay: true }
      ],
      materials: [
        { name: '商品混凝土C35', budget: 16800, purchased: 17500, consumed: 16900, unit: 'm³', warn: true, source: '供应链平台' },
        { name: 'HRB400钢筋', budget: 4200, purchased: 4150, consumed: 4080, unit: 't', warn: false, source: '供应链平台' },
        { name: '桩基材料', budget: 1200, purchased: 1150, consumed: 1120, unit: 't', warn: false, source: '供应链平台' },
        { name: '预拌砂浆', budget: 5600, purchased: 5450, consumed: 5300, unit: 't', warn: false, source: '供应链平台' },
        { name: '模板', budget: 32000, purchased: 29800, consumed: 29000, unit: 'm²', warn: false, source: '供应链平台' }
      ],
      outputByMajor: [
        { major: '土建', value: 1.38 },
        { major: '安装', value: 0.42 },
      ...
      honors: [
        { name: '广州市安全文明施工示范工地', date: '2026-09-30', status: '筹备', cert: false },
        { name: '绿色施工样板工地', date: '2026-12-31', status: '筹备', cert: false }
      ],
      inspections: [
        { date: '2026-05-26', type: '安全巡检', result: '发现1项隐患', status: '整改中', inspector: '质量安全部' },
        { date: '2026-05-22', type: '质量巡检', result: '合格', status: '已关闭', inspector: '质量安全部' },
        { date: '2026-05-18', type: '文明施工', result: '合格', status: '已关闭', inspector: '工程技术部' }
      ],
      majorEvents: [
        { date: '2025-09-01', title: 'AZ-01地块开工', type: '里程碑', desc: '均一均二复建AZ-01地块正式开工', image: '/assets/aerial/3月-1.jpg' },
        { date: '2025-11-15', title: '地下室开工', type: '进度', desc: '地下室结构施工启动', image: '/assets/aerial/3月-2.jpg' },
        { date: '2026-05-08', title: '利润率低于红线预警', type: '成本', desc: '当前实际利润率18.59%，高于红线但安全垫收窄', image: '/assets/aerial/5月-1.jpg' }
      ]
    },
    yt_az01: {
      licenses: [
        { name: '施工许可证', status: 'done', date: '2025-08-25', deadline: '—', warn: false },
        { name: '临水临电', status: 'done', date: '2025-09-05', deadline: '—', warn: false },
        { name: '林地林牌', status: 'done', date: '2025-10-15', deadline: '—', warn: false },
        { name: '分阶段验收备案', status: 'doing', date: '—', deadline: '2026-12-31', warn: false }
      ],
      designProgress: [
        { major: '建筑', plan: '2025-06-30', actual: '2025-07-05', rate: 100, lag: false },
        { major: '结构', plan: '2025-08-15', actual: '2025-08-20', rate: 100, lag: false },
        { major: '机电', plan: '2026-01-31', actual: '—', rate: 65, lag: false },
        { major: '精装修', plan: '2026-06-30', actual: '—', rate: 35, lag: false }
      ],
      milestones: [
        { name: '桩基工程完成', plan: '2026-03-31', actual: '2026-04-02', status: 'done', reason: '地质条件良好，提前完成' },
        { name: '地下室结构封顶', plan: '2026-09-30', actual: '—', status: 'doing', reason: '' },
        { name: '主体结构封顶', plan: '2027-06-30', actual: '—', status: 'pending', reason: '' },
        { name: '竣工验收', plan: '2028-03-31', actual: '—', status: 'pending', reason: '' }
      ],
      risks: {
        engineering: [
          { level: 'yellow', desc: '桩基检测报告滞后影响验收', owner: '李工', status: '处理中', deadline: '2026-05-28' }
        ],
        economic: [
          { level: 'blue', desc: '精装修材料价格波动风险', owner: '商务部', status: '已评估', deadline: '2026-06-20' }
        ],
        design: [
          { level: 'blue', desc: '景观深化设计待确认', owner: '工程技术部', status: '已评估', deadline: '2026-07-15' }
        ]
      },
      costSections: [
        { name: '前期工程', value: 0.11, pct: 2.0 },
        { name: '土方及基坑', value: 0.72, pct: 12.9 },
        { name: '地下室', value: 2.86, pct: 51.4 },
        { name: '高层住宅', value: 1.35, pct: 24.2 },
        { name: '公建配套', value: 0.17, pct: 3.1 },
        { name: '外墙', value: 0.30, pct: 5.4 },
        { name: '其他', value: 0.05, pct: 1.0 }
      ],
      threeValueCompare: [
        { major: '土方及基坑', tender: 0.76, bid: 0.72, target: 0.55, actual: 0.52 },
        { major: '地下室', tender: 2.92, bid: 2.77, target: 2.12, actual: 2.05 },
        { major: '高层住宅', tender: 1.42, bid: 1.35, target: 1.08, actual: 1.04 },
        { major: '外墙', tender: 0.33, bid: 0.30, target: 0.22, actual: 0.21 },
        { major: '精装修', tender: 0.62, bid: 0.58, target: 0.45, actual: 0.43 }
      ],
      benchmarkTop: [
        { item: '桩基工程', diff: 5.2, amount: 38.6, reason: '地层变化微调' }
      ],
      benchmarkSave: [
        { item: '土方工程', diff: -8.2, amount: -42.5, reason: '场内平衡利用' },
        { item: '混凝土工程', diff: -6.8, amount: -35.8, reason: '集中采购优惠' }
      ],
      otherDirectCosts: {
        versions: ['标前版', '第三方版', '一体化单位版'],
        items: [
          { name: '临时设施费', v1: 380, v2: 392, v3: 386 },
          { name: '安全文明施工费', v1: 520, v2: 535, v3: 528 },
          { name: '管理费', v1: 1280, v2: 1310, v3: 1295 },
          { name: '利润', v1: 1020, v2: 1045, v3: 1032 }
        ]
      },
      subcontracts: [
        { company: '广州浚凯土石方', contract: 520, paid: 280, remain: 240, overpay: false },
        { company: '粤建桩基工程', contract: 680, paid: 510, remain: 170, overpay: false },
        { company: '绿景园林', contract: 420, paid: 150, remain: 270, overpay: false }
      ],
      materials: [
        { name: '商品混凝土C30', budget: 9800, purchased: 9250, consumed: 9050, unit: 'm³', warn: false, source: '供应链平台' },
        { name: 'HRB400钢筋', budget: 2600, purchased: 2520, consumed: 2450, unit: 't', warn: false, source: '供应链平台' },
        { name: '蒸压加气砌块', budget: 6200, purchased: 5950, consumed: 5800, unit: 'm³', warn: false, source: '供应链平台' },
        { name: '预拌砂浆', budget: 3200, purchased: 3050, consumed: 2980, unit: 't', warn: false, source: '供应链平台' },
        { name: '模板', budget: 22000, purchased: 20500, consumed: 19900, unit: 'm²', warn: false, source: '供应链平台' }
      ],
      outputByMajor: [
        { major: '土建', value: 0.62 },
        { major: '安装', value: 0.18 },
      ...
      honors: [
        { name: '广州市绿色施工样板工地', date: '2027-06-30', status: '筹备', cert: false }
      ],
      inspections: [
        { date: '2026-05-27', type: '安全巡检', result: '合格', status: '已关闭', inspector: '质量安全部' },
        { date: '2026-05-23', type: '质量巡检', result: '合格', status: '已关闭', inspector: '质量安全部' },
        { date: '2026-05-19', type: '文明施工', result: '合格', status: '已关闭', inspector: '工程技术部' }
      ],
      majorEvents: [
        { date: '2025-09-01', title: '洋田地块开工', type: '里程碑', desc: '洋田复建AZ-01地块正式开工', image: '/assets/aerial/3月-1.jpg' },
        { date: '2026-04-02', title: '桩基工程完成', type: '进度', desc: '全部桩基施工完成，提前2天', image: '/assets/aerial/2月-2.jpg' },
        { date: '2026-05-25', title: '地下室负一层施工', type: '进度', desc: '地下室结构施工进行中', image: '/assets/aerial/5月-2.jpg' }
      ]
    },
    jyje_az02: {
      licenses: [
        { name: '用地规划许可', status: 'done', date: '2025-12-20', deadline: '—', warn: false },
        { name: '工程规划许可', status: 'doing', date: '—', deadline: '2026-06-30', warn: true },
        { name: '施工许可证', status: 'pending', date: '—', deadline: '2026-09-30', warn: false },
        { name: '临水临电', status: 'pending', date: '—', deadline: '2026-10-31', warn: false }
      ],
      designProgress: [
        { major: '建筑', plan: '2026-01-31', actual: '2026-02-10', rate: 100, lag: false },
        { major: '结构', plan: '2026-04-30', actual: '—', rate: 70, lag: false },
        { major: '机电', plan: '2026-08-31', actual: '—', rate: 20, lag: false },
        { major: '精装修', plan: '2027-03-31', actual: '—', rate: 5, lag: false }
      ],
      milestones: [
        { name: '场地移交', plan: '2026-01-31', actual: '—', status: 'doing', reason: '正在办理场地移交手续' },
        { name: '桩基工程完成', plan: '2026-08-31', actual: '—', status: 'pending', reason: '' },
        { name: '主体结构封顶', plan: '2028-12-31', actual: '—', status: 'pending', reason: '' },
        { name: '竣工验收', plan: '2029-12-31', actual: '—', status: 'pending', reason: '' }
      ],
      risks: {
        engineering: [
          { level: 'yellow', desc: '场地内管线迁改尚未完成', owner: '赵工', status: '处理中', deadline: '2026-07-31' }
        ],
        economic: [
          { level: 'blue', desc: '土地出让金分期缴纳安排', owner: '财务部', status: '已评估', deadline: '2026-08-31' }
        ],
        design: [
          { level: 'blue', desc: '方案设计深化待确认', owner: '工程技术部', status: '待处理', deadline: '2026-09-30' }
        ]
      },
      costSections: [
        { name: '前期工程', value: 0.08, pct: 2.0 },
        { name: '土方及基坑', value: 0.55, pct: 12.9 },
        { name: '地下室', value: 2.20, pct: 51.4 },
        { name: '高层住宅', value: 1.04, pct: 24.2 },
        { name: '公建配套', value: 0.13, pct: 3.1 },
        { name: '外墙', value: 0.23, pct: 5.4 },
        { name: '其他', value: 0.04, pct: 1.0 }
      ],
      threeValueCompare: [
        { major: '土方及基坑', tender: 0.58, bid: 0.55, target: 0.42, actual: null },
        { major: '地下室', tender: 2.25, bid: 2.14, target: 1.64, actual: null },
        { major: '高层住宅', tender: 1.10, bid: 1.04, target: 0.82, actual: null },
        { major: '外墙', tender: 0.25, bid: 0.23, target: 0.17, actual: null },
        { major: '精装修', tender: 0.48, bid: 0.45, target: 0.34, actual: null }
      ],
      benchmarkTop: [],
      benchmarkSave: [],
      otherDirectCosts: {
        versions: ['标前版', '第三方版', '一体化单位版'],
        items: [
          { name: '临时设施费', v1: 300, v2: 310, v3: 305 },
          { name: '安全文明施工费', v1: 460, v2: 470, v3: 465 },
          { name: '管理费', v1: 980, v2: 1000, v3: 990 },
          { name: '利润', v1: 820, v2: 835, v3: 828 }
        ]
      },
      subcontracts: [
        { company: '广州浚凯土石方', contract: 380, paid: 60, remain: 320, overpay: false }
      ],
      materials: [
        { name: '商品混凝土C30', budget: 2600, purchased: 0, consumed: 0, unit: 'm³', warn: false, source: '供应链平台' },
        { name: 'HRB400钢筋', budget: 800, purchased: 0, consumed: 0, unit: 't', warn: false, source: '供应链平台' }
      ],
      outputByMajor: [
        { major: '土建', value: 0.02 },
        { major: '安装', value: 0.01 }
      ...
      honors: [
        { name: '绿色建造示范项目申报', date: '2027-12-31', status: '筹备', cert: false }
      ],
      inspections: [
        { date: '2026-05-24', type: '安全巡检', result: '合格', status: '已关闭', inspector: '质量安全部' },
        { date: '2026-05-16', type: '文明施工', result: '合格', status: '已关闭', inspector: '工程技术部' }
      ],
      majorEvents: [
        { date: '2026-03-01', title: 'AZ-02地块筹备启动', type: '里程碑', desc: '均一均二复建AZ-02地块筹备启动', image: '/assets/aerial/1月-1.jpg' },
        { date: '2026-05-08', title: '场地移交办理', type: '进度', desc: '正在办理场地移交手续', image: '/assets/aerial/5月-1.jpg' }
      ]
    }
  },
