...
for (const p of P) {
  fs.writeFileSync(path.join(OUT, '合同资料', `${p.short}地块EPC总承包合同（要点摘录）.md`), `# ${p.short}地块 EPC 总承包合同（要点摘录）
...
${DEMO_NOTE}`);
  fs.writeFileSync(path.join(OUT, '成本月报', `${p.short}地块2026年6月成本月报.md`), `# ${p.short}地块 2026年6月成本月报
...
${DEMO_NOTE}`);
  fs.writeFileSync(path.join(OUT, '综合月报', `${p.short}地块2026年6月项目综合月报.md`), `# ${p.short}地块 2026年6月项目综合月报
